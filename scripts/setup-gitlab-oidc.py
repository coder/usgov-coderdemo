...
What it does:
  ...
  3. Read the client secret and upsert it into AWS Secrets Manager at
     usgov-coderdemo/gitlab/oidc as {"client-secret": "..."}.
...
REALM = "coder"
CLIENT_ID = "gitlab"
GITLAB_URL = "https://gitlab.usgov.coderdemo.io"
REGION = "us-gov-west-1"
ASM_NAME = "usgov-coderdemo/gitlab/oidc"
    ...
    try:
        ...
        subprocess.run(
            ["aws", "secretsmanager", "create-secret", "--region", REGION,
             "--name", name,
             "--description", "usgov-coderdemo GitLab OIDC client secret (ESO).",
             "--secret-string", ref],
            check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        return "created"
    finally:

# GitLab CE (single-container Omnibus) — `gitlab.usgov.coderdemo.io`
...
|----------------------------------------|----------------------------------------------------------------------------------------------|
| `docker.io/gitlab/gitlab-ce:19.0.1-ce.0` | `430737322961.dkr.ecr.us-gov-west-1.amazonaws.com/docker-hub/gitlab/gitlab-ce:19.0.1-ce.0` |
...
GitLab can SSO against Keycloak (`auth.usgov.coderdemo.io`, realm to be confirmed).
...
gitlab_rails['omniauth_providers'] = [
  {
    ...
    args: {
      ...
      response_type: 'code',
      issuer: 'https://auth.usgov.coderdemo.io/realms/<realm>',
      discovery: true,
      ...
      client_options: {
        ...
        redirect_uri: 'https://gitlab.usgov.coderdemo.io/users/auth/openid_connect/callback'
      }
    }
  }
]

...
| Grafana | Deployment `kps-grafana`, 5Gi gp3 PVC. Service `kps-grafana:80`. Admin password from AWS Secrets Manager via ESO. |
...
# 4. Namespace + ESO ExternalSecret for the Grafana admin secret.
...
kubectl -n monitoring get externalsecret grafana-admin   # Ready=SecretSynced
